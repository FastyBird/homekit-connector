...
final class SrpTest extends BaseTestCase
{
	...
	private const TEST_CLIENT_PUBLIC_KEY = 'FAB6F5D2 615D1E32 3512E799 1CC37443 F487DA60 4CA8C923 0FCB04E5 41DCE628'
	...
	private const TEST_SERVER_PUBLIC_KEY = '40F57088 A482D4C7 733384FE 0D301FDD CA9080AD 7D4F6FDF 09A01006 C3CB6D56'
	...
	private const TEST_SERVER_PASSWORD_VERIFIER = '9B5E0617 01EA7AEB 39CF6E35 19655A85 3CF94C75 CAF2555E F1FAF759 BB79CB47'
	...
	private const TEST_RANDOM_SCRAMBLING_PARAMETER = '03AE5F3C 3FA9EFF1 A50D7DBB 8D2F60A1 EA66EA71 2D50AE97 6EE34641 A1CD0E51'
		. 'C4683DA3 83E8595D 6CB56A15 D5FBC754 3E07FBDD D316217E 01A391A1 8EF06DFF';
	private const TEST_PREMASTER_SECRET = 'F1036FEC D017C823 9C0D5AF7 E0FCF0D4 08B009E3 6411618A 60B23AAB BFC38339'
	...
	private const TEST_SESSION_KEY = '5CBC219D B052138E E1148C71 CD449896 3D682549 CE91CA24 F098468F 06015BEB'
		. '6AF245C2 093F98C3 651BCA83 AB8CAB2B 580BBF02 184FEFDF 26142F73 DF95AC50';
	private const TEST_CLIENT_PROOF_OF_SESSION_KEY = '5F7C14AB 57ED0E94 FD1D78C6 B4DD09ED 7E340B7E 05D419A9 FD760F6B 35E523D1'
		. '310777A1 AE1D2826 F596F3A8 5116CC45 7C7C964D 4F44DED5 559DA818 C88B617F';
	private const TEST_SERVER_PROOF_OF_SESSION_KEY = '2FA0E81F 5CB73B88 FA096427 0F321DD6 41F2227A 5D805C40 F1BFE96A AF6A19FF'
